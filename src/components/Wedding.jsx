...
function Wedding() {
  ...
  const WeddingCollection = products.filter((item) =>
    ["Wedding"].includes(
      item.collection
    )
          ...
          {WeddingCollection.map((val) => (
            ...
            >
              ...
              <img
                src={val.image}
                alt=""
                className="h-50 p-2 w-full object-cover bg-slate-100  rounded-lg"
              />
            ...
            <div className="p-2 ">
              ...
              <p className="bg-gray-300/50 w-25   text-center text-sm rounded-sm ">{val.badge}</p>
               </div>
              </div>
